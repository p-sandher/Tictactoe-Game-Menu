...
public class TictactoeView extends JPanel {
    ...
    /**
     * @param GameUI root 
     * TictactoeView constructor, sets GUI view and starts the game 
     */
    public TictactoeView(GameUI root) {
        super();
        setLayout(new BorderLayout());
        parent = root;
        controller = new TictactoeGame(3, 3);
        controller.newGame();
    ...
    public void addGamePiece(ActionEvent e) {
        ...
        int option = 0;
        JOptionPane pickPosition = new JOptionPane();
        option = pickPosition.showConfirmDialog(null,"Do you want this position?","", JOptionPane.YES_NO_OPTION);
        if(option == JOptionPane.YES_OPTION){
            PositionAwareButton clicked = ((PositionAwareButton) (e.getSource()));
            try{
                controller.takeTurn(clicked.getAcross(), clicked.getDown(), controller.getPlayerString());
    ...
    private JPanel makeTitlePanel(){
        ...
        title.add(new JLabel(controller.nameOfGame()));
